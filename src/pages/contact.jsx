...
const Contact = () => {
  ...
  return (
    <>
    <Navbar />
<section className="bg-blue-50 dark:bg-red-600" id="contact">
    <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div className="mb-4">
            <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                ...
                <p className="mx-auto mt-4 max-w-3xl text-xl text-gray-600 dark:text-slate-400">Need a content writer ?
                </p>
            </div>
        </div>
        <div className="flex items-stretch justify-center">
            <div className="grid md:grid-cols-2">
                <div className="h-full pr-10">
                    ...
                    I’m so excited that you’re ready to get started. Please send an official message telling me more about your project.
                    </p>
                    <ul className="mb-6 ml-8 md:mb-0 md:ml-0">
                        <li className="flex">
                            ...
                            <div className="ml-4 mb-4">
                                <lee className="mb-2 text-2xl font-medium leading-6 text-gray-900 dark:text-white">Address
                                </lee>
                                <p className="text-gray-600 dark:text-slate-400">Enugu</p>
                                <p className="text-gray-600 dark:text-slate-400">Nigeria</p>
                            </div>
                        </li>
                        <li className="flex">
                            <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                            ...
                            <div className="ml-4 mb-4">
                                <lee className="mb-2 text-2xl font-medium leading-6 text-gray-900 dark:text-white">Contact
                                </lee>
                                <p className="text-gray-600 dark:text-slate-400">Mobile: +234 8103641711</p>
                                <p className="text-gray-600 dark:text-slate-400">Mail: amakageorge521@gmail.com</p>
                            </div>
                        </li>
                        <li className="flex">
                            <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                            ...
                            <div className="ml-4 mb-4">
                                <lee className="mb-2 text-2xl font-medium leading-6 text-gray-900 dark:text-white">Working
                                    hours</lee>
                ...
                <div className="card h-fit max-w-6xl p-5 md:p-12" id="htmlForm">
                    ...
                    <htmlForm id="contacthtmlForm">
                        ...
                        <div className="text-center">
                            <button type="submit" 
                            className="w-full bg-blue-800 text-white px-6 py-3 font-xl rounded-md hover:bg-blue-500 sm:mb-0">Send Message</button>
                        </div>
                    </htmlForm>
                </div>
            </div>
